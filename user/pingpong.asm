...
int main(){
  ...
  28:	ed25                	bnez	a0,a0 <main+0xa0>
        close(p1[0]);
  2a:	fe842503          	lw	a0,-24(s0)
  2e:	00000097          	auipc	ra,0x0
  32:	376080e7          	jalr	886(ra) # 3a4 <close>
        close(p2[1]);
  36:	fe442503          	lw	a0,-28(s0)
  3a:	00000097          	auipc	ra,0x0
  3e:	36a080e7          	jalr	874(ra) # 3a4 <close>
        if(read(p2[0],&p2c,1))
  42:	4605                	li	a2,1
  44:	fdf40593          	addi	a1,s0,-33
  48:	fe042503          	lw	a0,-32(s0)
  4c:	00000097          	auipc	ra,0x0
  50:	348080e7          	jalr	840(ra) # 394 <read>
  54:	e51d                	bnez	a0,82 <main+0x82>
            fprintf(1,"%d: received ping\n", getpid());
        write(p1[1], "o", 1);
  56:	4605                	li	a2,1
  58:	00001597          	auipc	a1,0x1
  5c:	85858593          	addi	a1,a1,-1960 # 8b0 <malloc+0xfe>
  ...
  7e:	302080e7          	jalr	770(ra) # 37c <exit>
            fprintf(1,"%d: received ping\n", getpid());
  82:	00000097          	auipc	ra,0x0
  86:	37a080e7          	jalr	890(ra) # 3fc <getpid>
  8a:	862a                	mv	a2,a0
  8c:	00001597          	auipc	a1,0x1
  90:	80c58593          	addi	a1,a1,-2036 # 898 <malloc+0xe6>
  94:	4505                	li	a0,1
  96:	00000097          	auipc	ra,0x0
  9a:	630080e7          	jalr	1584(ra) # 6c6 <fprintf>
  9e:	bf65                	j	56 <main+0x56>
        close(p1[1]);
  a0:	fec42503          	lw	a0,-20(s0)
  a4:	00000097          	auipc	ra,0x0
  a8:	300080e7          	jalr	768(ra) # 3a4 <close>
        close(p2[0]);
  ac:	fe042503          	lw	a0,-32(s0)
  b0:	00000097          	auipc	ra,0x0
  b4:	2f4080e7          	jalr	756(ra) # 3a4 <close>
        write(p2[1],"i", 1);
  b8:	4605                	li	a2,1
  ba:	00000597          	auipc	a1,0x0
  be:	7fe58593          	addi	a1,a1,2046 # 8b8 <malloc+0x106>
  c2:	fe442503          	lw	a0,-28(s0)
  c6:	00000097          	auipc	ra,0x0
  ca:	2d6080e7          	jalr	726(ra) # 39c <write>
        if(read(p1[0],&c2p,1))
  ce:	4605                	li	a2,1
  d0:	fde40593          	addi	a1,s0,-34
  d4:	fe842503          	lw	a0,-24(s0)
  d8:	00000097          	auipc	ra,0x0
  dc:	2bc080e7          	jalr	700(ra) # 394 <read>
  e0:	e901                	bnez	a0,f0 <main+0xf0>
        close(p2[1]);
  e2:	fe442503          	lw	a0,-28(s0)
  e6:	00000097          	auipc	ra,0x0
  ea:	2be080e7          	jalr	702(ra) # 3a4 <close>
  ee:	b769                	j	78 <main+0x78>
            fprintf(1, "%d: received pong\n", getpid());
  f0:	00000097          	auipc	ra,0x0
  f4:	30c080e7          	jalr	780(ra) # 3fc <getpid>
  f8:	862a                	mv	a2,a0
  fa:	00000597          	auipc	a1,0x0
  fe:	7c658593          	addi	a1,a1,1990 # 8c0 <malloc+0x10e>
 102:	4505                	li	a0,1
 104:	00000097          	auipc	ra,0x0
 108:	5c2080e7          	jalr	1474(ra) # 6c6 <fprintf>
 10c:	bfd9                	j	e2 <main+0xe2>
...
free(void *ap)
{
 ...
 738:	1c47b783          	ld	a5,452(a5) # 8f8 <freep>
 ...
 766:	00e6ea63          	bltu	a3,a4,77a <free+0x50>
{
 ...
 7a8:	14f73a23          	sd	a5,340(a4) # 8f8 <freep>
}
 7ac:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7da:	12253503          	ld	a0,290(a0) # 8f8 <freep>
 ...
 802:	0fa90913          	addi	s2,s2,250 # 8f8 <freep>
  if(p == (char*)-1)
 806:	5afd                	li	s5,-1
 808:	a895                	j	87c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 80a:	00000797          	auipc	a5,0x0
 80e:	0f678793          	addi	a5,a5,246 # 900 <base>
 812:	00000717          	auipc	a4,0x0
 816:	0ef73323          	sd	a5,230(a4) # 8f8 <freep>
 81a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 83e:	0aa73f23          	sd	a0,190(a4) # 8f8 <freep>
      return (void*)(p + 1);
 ...
 88c:	b7c080e7          	jalr	-1156(ra) # 404 <sbrk>
  if(p == (char*)-1)
